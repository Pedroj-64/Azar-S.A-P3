defmodule ProyectoWeb.Player.LoginLive do
  ...
  def mount(_params, _session, socket) do
    {:ok, assign(socket, page_title: "Ingresar")}
  end
      ...
      <div class="relative z-10 w-full max-w-md mx-auto px-6">
        ...
        <div class="vintage-card halo p-8">
          <div class="text-center mb-8">
            ...
            <h1 class="font-display text-3xl text-[var(--crema)] neon-teal">Bienvenido</h1>
          ...
          <div class="divider-ornament mt-6 mb-4 text-[0.6rem]">primera vez</div>
